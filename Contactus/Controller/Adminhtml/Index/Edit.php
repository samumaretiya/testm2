...
class Edit extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($id) {
            $model->load($id);
            if (!$model->getId()) {
                $this->messageManager->addError(__('This contactus no longer exists.'));
        ...
        $resultPage->getConfig()->getTitle()->prepend(__('Manage Contact Enquiries'));
        $resultPage->getConfig()->getTitle()->prepend($id ? __('View Contact Enquiries') : __('Manage Contact Us'));
        return $resultPage;
    }
}
