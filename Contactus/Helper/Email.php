...
class Email extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    const XML_PATH_EMAIL_TEMPLATE_FIELD_CUSTOMER  = 'contactus/view/email_template';
	 const XML_PATH_EMAIL_TEMPLATE_FIELD_ADMIN  = 'contactus/view/admin_email';
    ...
    */
    ...
    public function contactEnquiryMailSendMethod($emailTemplateVariables,$senderInfo,$receiverInfo)
    {
	...
	public function contactMailSendMethodToCustomer($emailTemplateVariables,$senderInfo,$receiverInfo)
    {
