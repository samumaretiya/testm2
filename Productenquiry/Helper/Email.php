...
{
    const XML_PATH_EMAIL_TEMPLATE_FIELD  = 'productenquiry/view/admin_email';
    ...
    */
    ...
    public function enquiryMailSendMethod($emailTemplateVariables,$senderInfo,$receiverInfo)
    {
		$this->temp_id = $this->getTemplateId(self::XML_PATH_EMAIL_TEMPLATE_FIELD);
        $this->inlineTranslation->suspend();    
        $this->generateTemplate($emailTemplateVariables,$senderInfo,$receiverInfo);    
        $transport = $this->_transportBuilder->getTransport();
		//var_dump($this->_transportBuilder->prepareAttchMessage());exit;
        $transport->sendMessage();
        $this->inlineTranslation->resume();
    }
	public function enquiryMailSendMethodToCustomer($emailTemplateVariables,$senderInfo,$receiverInfo)
    {
