...
/**
 * Productenquiry data helper
 */
namespace Digital\Productenquiry\Helper;
...
{
    /**
     * Path to store config where count of productenquiry posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'productenquiry/view/items_per_page';
    const XML_PATH_ENABLE     = "productenquiry/view/status";
    const XML_PATH_CAPTCHA_ENABLE   = "productenquiry/view/captcha_enable";
     ...
     * @var string
     */
    const MEDIA_PATH    = 'Productenquiry';
    ...
    /**
     * Remove Productenquiry item image by image filename
     *
     ...
     * @return bool|string
     */
    public function resize(\Digital\Productenquiry\Model\Productenquiry $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Productenquiry Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Productenquiry Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getProductenquiryPerPage()
    {
