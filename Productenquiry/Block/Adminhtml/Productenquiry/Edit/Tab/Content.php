...
/**
 * productenquiry edit form main tab
 */
    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /** @var $model Digital\ProductenquiryModel\Productenquiry */
        ...
        $form->setHtmlIdPrefix('productenquiry_content_');
        ...
        $this->_eventManager->dispatch('adminhtml_productenquiry_edit_tab_content_prepare_form', ['form' => $form]);
