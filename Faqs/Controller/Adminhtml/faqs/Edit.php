...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Digital_Faqs::Faqs')
            ->addBreadcrumb(__('Digital Faqs'), __('Digital Faqs'))
    ...
    public function execute()
    {
        ...
        $resultPage->getConfig()->getTitle()->prepend($id ? __('Edit FAQ') : __('New FAQ'));
        /* $resultPage->getConfig()->getTitle()->prepend($model->getId() ? $model->getTitle() : __('Faqs')); */
