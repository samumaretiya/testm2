...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    {
        if ($this->_coreRegistry->registry('faqs')->getId()) {
            return __("Edit FAQ '%1'", $this->escapeHtml($this->_coreRegistry->registry('faqs')->getTitle()));
        } else {
            return __('New FAQ');
        }
    }
    ...
    {
        return $this->getUrl('faqs/*/save', ['_current' => true, 'back' => 'edit', 'active_tab' => '{{tab_id}}']);
    }
